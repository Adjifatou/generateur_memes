    ...
    <nav class="navbar navbar-default navbar-fixed-top" >
        ...
        <div class="collapse navbar-collapse" id="navcol-1">
            <ul class="nav navbar-nav navbar-right">
                <li role="presentation"><a href="acceuil.php">Accueil</a></li>
                <li role="presentation"><a href="Inscription.php">Deconnexion </a></li>
...
<div class="example default" style="width: 700px">
    ...
    <img id="img" src="IMG/meme1.png" alt="your image"  name="image" width="400">
</div>
...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-4">
            <button class="btn btn-success"  id="save">apercu</button>
            <button class="btn btn-danger"type="submit" id="download">Telecharger</button>
        </div>
    </div>
</div>
</div>
